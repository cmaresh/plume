...
class Menu {
    ...
    addOption(id, submenu = [], action = null, innerHTML = '') {
        ...
        if (id == 'add') {
            newOption.submenu = ['default', 'selection', 'editing'];
        ...
        if (id == 'shiftup') {
            newOption.submenu = ['selection', 'editing'];
    ...
    toggleSubmenu(submenu) {
        this.options.forEach(option => {
            console.log(option.submenu.includes(submenu));
            if (option.submenu.includes(submenu)) {
